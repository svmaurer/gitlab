...
#  bind_dn: 'CN=GIT AD Connector,OU=Functional Users,OU=Users,OU=customer AG,DC=customer,DC=dc'
#  password: 'start123'
#  active_directory: true
#  allow_username_or_email_login: false
#  base: 'OU=Users,OU=customer AG,DC=customer,DC=dc'
#  user_filter: '(&(sAMAccountName=*)(memberOf=CN=gituser,OU=Groups,OU=customer AG,DC=customer,DC=dc))'
#  timeout: 10
#EOS
...
gitlab_rails['git_max_size'] = 520971520
...
gitlab_rails['smtp_address'] = "mailout.localhost"
...
nginx['listen_port'] = 20080 # override only if you use a reverse proxy: https://gitlab.com/gitlab-org/omnibus-gitlab/blob/master/doc/settings/nginx.md#setting-the-nginx-listen-port
